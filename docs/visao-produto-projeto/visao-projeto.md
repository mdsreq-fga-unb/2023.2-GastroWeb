...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Desenvolvedor Frontend                    | Codificar com foco nas implementações web e frontend do produto, de acordo com os requisitos levantados.                                                       | Felipe Hansen                               | Felipe Direito<br> Felipe Hansen<br> Luan Mateus<br> Lucas Lobão<br> Matheus Henrick<br> Pedro Sampaio |
| Desenvolvedor Backend                     | Codificar com foco nas implementações backend do produto, de acordo com os requisitos levantados.                                                              | Felipe Direito                               | Felipe Direito<br> Felipe Hansen<br> Luan Mateus<br> Lucas Lobão<br> Matheus Henrick<br> Pedro Sampaio                                                                                         |
| Desenvolvedor Master Scrum                | Certificar que a equipe está se comprometendo com aquilo que consegue cumprir. Remover qualquer interferência prejudicial ao time. Líder facilitador do Scrum. | Luan Mateus                                 | Felipe Direito<br> Felipe Hansen<br> Luan Mateus<br> Lucas Lobão<br> Matheus Henrick<br> Pedro Sampaio |
| Analista de Qualidade                     | Garantir a qualidade do produto, garantir o cumprimento do conceito de pronto, realizar inspeções de código                                                    | Matheus Henrick                             | Felipe Direito<br> Felipe Hansen<br> Luan Mateus<br> Lucas Lobão<br> Matheus Henrick<br> Pedro Sampaio |
| Product Owner                             | Atualizar o escopo do produto, organizar o escopo das sprints, validar as entregas                                                                             | Felipe Direito                              | Felipe Direito<br> Felipe Hansen<br> Luan Mateus<br> Lucas Lobão<br> Matheus Henrick<br> Pedro Sampaio |
| Responsavel pela Engenharia de Requisitos | Encarregado de certificar e executar as atividades da Engenharia de Requisitos                                                                                             | Pedro Sampaio                               | Felipe Direito<br> Felipe Hansen<br> Luan Mateus<br> Lucas Lobão<br> Matheus Henrick<br> Pedro Sampaio |
| Cliente                                   | Identificar requisitos, validar as entregas, fornecer feedbacks e tomar decisões de negócios.                     | Luísa Schimidt <br> George Marsicano Correa | Luísa Schimidt <br> George Marsicano Correa                                                            |
